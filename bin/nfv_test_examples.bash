...
#./run_testset.bash -r "20000000" -b 32 -p "64 128 256 512 1024 1500" -v "ovs sriov vpp basicfwd snabb" -c -f configurations/confrc-latencyst-local-host1-1vs1.bash -o out-local-1v1-lat
# ./run_testset.bash -r "1000" -b "4 8 16 32 64 128 256 512" -p "64 128 256 512 1024 1500" -v "ovs sriov vpp basicfwd snabb" -c -f configurations/confrc-latency-local-host1-1vs1.bash -o out-local-1v1-lat
# ./run_testset.bash -r "1000" -b "4 8 16 32 64 128 256 512" -p "64 128 256 512 1024 1500" -v "ovs sriov vpp basicfwd snabb" -c -f configurations/confrc-latency-remote-host1-1vs1.bash -H host2 -F configurations/confrc-latency-remote-host2-1vs1.bash -o out-remote-1v1-lat
