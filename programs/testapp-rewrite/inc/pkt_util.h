...
static inline void produce_data_offset(void *payload_v, size_t size, size_t offset)
{
...
static inline bool consume_data_offset(void *payload_v, size_t size, size_t offset)
{
...
#define PUT_V(type, array, value) \
    PUT_OFFSET_V(type, array, 0, value)
